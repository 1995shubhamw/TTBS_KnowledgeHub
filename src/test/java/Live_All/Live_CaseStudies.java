...
public class Live_CaseStudies {
    ...
    public void setUp() {
        ...
        driver.get("https://www.tatatelebusiness.com/case-studies/");
    }
    ...
    public void testLoadCaseStudies()
    {
        ...
        System.out.println("Total Case Studies Count for live_All: " + caseStudiesNames.size());
