...
public class Live_CloudAndSaas {
    ...
    public void setUp() 
    {
        ...
        driver.get("https://www.tatatelebusiness.com/cloud-and-saas/");
    }
    @Test
    public void testLoadArticles() 
    {
        ...
        System.out.println("Total article Count for live_All: " + cloudAndSaasNames.size());
