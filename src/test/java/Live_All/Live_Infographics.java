...
public class Live_Infographics 
{
    ...
    public void setUp() {
        ...
        driver.get("https://www.tatatelebusiness.com/infographics/");
    }
    ...
    public void testLoadInfographics() {
        ...
        System.out.println("Total Infographics Count for Live: " + infographicsNames.size());
