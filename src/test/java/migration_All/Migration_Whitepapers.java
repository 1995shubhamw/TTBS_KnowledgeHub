...
public class Migration_Whitepapers {
    ...
    public void setUp() 
    {
        ...
        driver.get("http://ttbs-migration-dev.allsocialassets.com/whitepapers/");
    }
    ...
    public void testLoadWhitePapers() 
    {
        ...
        System.out.println("Total whitePapers Count for Migrations: " + whitepaperNames.size());
