...
public class Migration_Podcasts {
    ...
    public void setUp() {
        ...
        driver.get("http://ttbs-migration-dev.allsocialassets.com/podcasts/");
    }
    ...
    public void testLoadPodcasts() 
    {
        ...
        System.out.println("Total podcast Countcfor Migrations: " + podcastNames.size());
        System.out.println("podcast Names:");
