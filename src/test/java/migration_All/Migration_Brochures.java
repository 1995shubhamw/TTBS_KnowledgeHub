...
public class Migration_Brochures
{
    ...
    public void setUp() {
        ...
        driver.get("http://ttbs-migration-dev.allsocialassets.com/brochures/");
    }
    ...
    public void testLoadBrochures() 
    {
        ...
        System.out.println("Total brochure Count for Migrations: " + brochuresNames.size());
