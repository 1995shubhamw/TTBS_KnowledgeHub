...
public class Migrations_Features
{
    ...
    public void setUp() 
    {
        ...
        driver.get("https://ttbs-migration-dev.allsocialassets.com/features/");
    }
    ...
    public void testLoadBrochures() 
    {
        ...
        System.out.println("Total features Count for Migration: " + featuresNames.size());
